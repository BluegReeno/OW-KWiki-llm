...
- **June 2025**: The Equinor/EDF/ESB-linked developer group secured a 1.5 GW site
  in the Crown Estate's Round 5 floating offshore wind leasing process, part of
  UK Round 5 floating wind leasing in the Celtic Sea.
- **October 2025**: Signed an Agreement for Lease with the Crown Estate.
- **November 2025**: Appointed Haskoning to lead the Environmental Impact
  Assessment (EIA) process, with NASH Maritime selected for shipping and
  navigation assessments.
- **July 2026**: Submitted an EIA Scoping Report to the UK Planning
...
Gwynt Glas is being progressed as a Nationally Significant Infrastructure
Project (NSIP) and will require a Development Consent Order (DCO) as well as
